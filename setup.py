...
package_init = (here / "src" / "summarytools" / "__init__.py").read_text(encoding="utf-8")
version = re.search(r'^__version__ = ["\']([^"\']+)["\']', package_init, re.MULTILINE).group(1)
